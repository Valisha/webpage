...
image: '/blog_images/biobank1/ukb_genetic_timeline.png'
imageAlt: 'A tree ring visualization where each ring is a relevant UKB release'
imageDescription: "UK Biobank's genetic data has grown over time, from microarray genotyping to whole genome sequencing."
...
```bash
bash firstpos.sh 11 2366
```

returns 47,319,031. This is just below my target region, which is a good sign.
